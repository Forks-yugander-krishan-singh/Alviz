...
(function(d, s, id) {
    ...
    js.src = 'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.11&appId=153065445252076';
...
! function() {
  Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function(t) {
    ...
    return e.e = function(t, e) {}, e.e = function(t, n) {
      ...
      if (void 0 !== i[t]) i[t].push(n);
        ...
        o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function() {
          ...
          1: "45193a41ef2a4c4048d10bcc9ffed027",
          2: "e3d988d72a52909fc67d44f2acde830e",
          3: "19ab31663e7415c077039cf06895d71d",
          4: "105d8dc580df0aa9af379adccee43f61",
          5: "dd8f4e0f21959350662db6b66a0a1551",
          6: "0a0756cf5fd6a263c896e31e41792129",
          7: "99ee96f633536393eb7114fb5b7b19f1"
    ...
    var r, i = n(1),
      ...
      m = n(240),
      v = "_e";
    n(274), u.set("widgets.init", !0), s.set("init", !0), p(), r = new i, a.exposeReadyPromise(r.promise, s.base, v), s.set("widgets", l), s.set("widgets.load", f.load), s.set("events", d), h(function() {
      r.resolve(s.base), c.attachTo(o), m.emitter.trigger(m.START), f.loadPage()
    })
  }, function(t, e, n) {
    function r() {
      var t = this;
    ...
    (function(t) {
      ...
      (function() {
        ...
        function E(t, e) {
          e._state === rt ? C(t, e._result) : e._state === it ? R(t, e._result) : I(e, void 0, function(e) {
            T(t, e)
          }, function(e) {
            R(t, e)
          })
        ...
        function x(t, e) {
          if (e.constructor === t.constructor) E(t, e);
            ...
            var n = y(e);
            n === ot ? R(t, ot.error) : void 0 === n ? C(t, e) : o(n) ? _(t, e, n) : C(t, e)
          }
        }
        function T(t, e) {
        ...
        function R(t, e) {
          t._state === nt && (t._state = it, t._result = e, K(A, t))
        }
        function I(t, e, n, r) {
        ...
        function j(t, e, n, r) {
          var i, a, s, u, c = o(n);
          if (c) {
            if (i = N(n, r), i === at ? (u = !0, a = i.error, i = null) : s = !0, e === i) return void R(e, w())
          } else i = r, s = !0;
          e._state !== nt || (c && s ? T(e, i) : u ? R(e, a) : t === rt ? C(e, i) : t === it && R(e, i))
        }
        function k(t, e) {
          try {
            e(function(e) {
        ...
        function L(t, e) {
          var n = this;
          n._instanceConstructor = t, n.promise = new t(v), n._validateInput(e) ? (n._input = e, n.length = e.length, n._remaining = e.length, n._init(), 0 === n.length ? C(n.promise, n._result) : (n.length = n.length || 0, n._enumerate(), 0 === n._remaining && C(n.promise, n._result))) : R(n.promise, n._validationError())
        }
        function O(t) {
        ...
        function D(t) {
          ...
          var r = this,
            i = new r(v);
          if (!Q(t)) return R(i, new TypeError("You must pass an array to race.")), i;
        ...
        L.prototype._enumerate = function() {
          ...
          var r = this,
            i = r.promise;
          i._state === nt && (r._remaining--, t === it ? R(i, n) : r._result[e] = n), 0 === r._remaining && C(i, r._result)
        ...
        var ut = O,
          ...
          lt = 0,
          ht = M;
        M.all = ut, M.race = ct, M.resolve = dt, M.reject = ft, M._setScheduler = s, M._setAsap = u, M._asap = K, M.prototype = {
          constructor: M,
          then: function(t, e) {
            var n = this,
              r = n._state;
    ...
    function r(t) {
      return t = t || g, t.devicePixelRatio ? t.devicePixelRatio >= 1.5 : !!t.matchMedia && t.matchMedia("only screen and (min-resolution: 144dpi)").matches
    }
    function i(t) {
      return t = t || y, /(Trident|MSIE|Edge[\/ ]?\d)/.test(t)
    }
    function o(t) {
      return t = t || y, /MSIE 9/.test(t)
    }
    function a(t) {
      return t = t || y, /MSIE 10/.test(t)
    }
    function s(t) {
    ...
    function c(t, e) {
      return t = t || g, e = e || y, t.postMessage && !(i(e) && t.opener)
    }
    function d(t, e, n) {
      return t = t || g, e = e || v, n = n || y, "ontouchstart" in t || /Opera Mini/.test(n) || e.msMaxTouchPoints > 0
    }
    function f() {
      var t = m.body.style;
    ...
    function p() {
      return g.performance && g.performance.getEntriesByType
    }
    var m = n(9),
      v = n(10),
      g = n(7),
    ...
    function i() {
      ...
      return !m.isFalseValue(t) && (m.isTruthValue(t) ? s.body : s.querySelectorAll(t))
    }
    function o(t) {
      var e;
      return t = t || s.body, t = t.length ? v.toRealArray(t) : [t], h.pause(), e = c.allResolved(r(t).map(function(t) {
    ...
    function r(t) {
      var e, n, r, i = 0;
      for (o = {}, t = t || a, e = t.getElementsByTagName("meta"); e[i]; i++) n = e[i], /^twitter:/.test(n.name) && (r = n.name.replace(/^twitter:/, ""), o[r] = n.content)
    }
    function i(t) {
      return o[t]
    }
    ...
    function o(t) {
      var e, n, o;
      0 !== t.length && h.isUnbucketed().then(function(a) {
        return a && l.flagUnbucketedScribeItems(t), 1 === t.length ? r(t) : (e = c(t, function(t) {
    ...
    function r() {
      ...
      return S ? P.promise : (h = new E(m), h.insert("rufous-sandbox", null, {
        display: "none"
      }, t).then(function() {
    ...
    function a(t, e, n, r) {
      o(t, e) || (T && T(arguments), P.promise.then(function() {
    ...
    function c() {
      ...
      return I++, t.action = b.CLIENT_EVENT_ENDPOINT, t.method = "POST", t.target = C + I, t.id = R + I, e.type = "hidden", e.name = "dnt", e.value = g.enabled(), n.type = "hidden", n.name = "tfw_redirect", n.value = b.RUFOUS_REDIRECT, t.appendChild(e), t.appendChild(n), t
    }
    function d() {
      var t = C + I;
      return v({
    ...
    var f, l, h, p = n(9),
      ...
      E = n(52),
      x = n(16),
      T = x.get("scribeCallback"),
      A = Math.floor(1e3 * Math.random()) + "_",
      C = "rufous-frame-" + A + "-",
      R = "rufous-form-" + A + "-",
      I = 0,
      S = !1,
    ...
    function i() {
      for (var t, e = a.getElementsByTagName("link"), n = 0; e[n]; n++)
    ...
    function o(t, e, n) {
      ...
      return t = a("tfw_client_event", t, r), t.client_version = y, t.format_version = void 0 !== n ? n : 1, e || (t.widget_origin = r), t
    }
    function a(t, e, n) {
      return e = e || {}, v.aug({}, e, {
        _category_: t,
    ...
    function s(t, e) {
      var n = {};
      return e = e || {}, e.association_namespace = i(t), n[x] = e, n
    }
    function u(t, e) {
      return v.aug({}, e, {
        event_namespace: t
    ...
    var h = n(9),
      ...
      w = n(16),
      y = g.version,
      b = w.get("clientEventEndpoint") || "https://syndication.twitter.com/i/jot",
      _ = "https://syndication.twitter.com/i/jot/syndication",
      E = "https://platform.twitter.com/jot.html",
      x = 1;
    t.exports = {
    ...
    function a(t) {
      t.overrideProperty("id", {
        ...
        return c.write(E(a, null, f)), f.addEventListener("load", function() {
          ...
          return s._iframe = t, s.win.addEventListener("resize", e, !1), w.all([s._setTargetToBlank(), s.addRootClass(C), s.prependCss(R)])
        })
    ...
    function i(t, e, n, r) {
      var i = !v.isObject(t),
        o = !!e && !v.isObject(e);
      i || o || (w && w(arguments), a(m.formatClientEventNamespace(t), m.formatClientEventData(e, n, r), m.CLIENT_EVENT_ENDPOINT))
    }
    function o(t, e, n, r) {
    ...
    function r() {
      d = p.isBucketedCookie(), f = l(), d.then(function(t) {
        c = t
      }), f.then(function(t) {
        var e = void 0 !== c;
        g && e && c !== t.isBucketed && (v = !0), w = !0
      })
    }
    function i() {
    ...
    function o() {
      var t;
      return g = !0, t = w ? f.then(function(t) {
        return t.isBucketed
      }) : m.always(d).then(function() {
        return w ? f.then(function(t) {
          return t.isBucketed
        }) : h.resolve(c)
      }), t.catch(function() {
        return !1
    ...
    function a() {
      return f.then(function(t) {
        return t.experiments ? Object.keys(t.experiments) : []
      }).catch(function(t) {
        return []
      })
    }
    function s(t) {
      return f.then(function(e) {
        if (!e.experiments || !e.experiments[t]) throw new Error("Experiment not found");
    ...
    var r, i = n(74),
      ...
      d = "settings-load";
    t.exports = function() {
      return r || (s.start(d), r = i.request(a.settings()).then(function(t) {
        return s.endAndTrack("load_settings_success", d, "page", {
          widget_origin: o.rootDocumentLocation(),
          widget_frame: o.isFramed() && o.currentDocumentLocation()
        }), r = void 0, new c(t.is_bucketed, t.should_obtain_cookie_consent, t.experiments)
      }).catch(function(t) {
        return s.endAndTrack("load_settings_failed", d, "page", {
          widget_origin: o.rootDocumentLocation(),
          widget_frame: o.isFramed() && o.currentDocumentLocation()
        }), r = void 0, u.reject(t)
      })), r
    ...
    function i(t, e) {
      function n() {
        var t = o ? r.contentType : r.getResponseHeader("content-type"),
          n = l.contains(t, m.JSON) ? a(r.responseText) : r.responseText;
    ...
    function r() {
      var t, e, n, r, i, y, b = new a;
      return p.ie9() || p.ie10() || "http:" !== d.protocol && "https:" !== d.protocol ? (b.resolve({}), b.promise) : (f.start(w), t = {
        namespace: g,
        origin: d.origin
      }, e = l.url(m.resourceBaseUrl + m.widgetIframeHtmlPath, t), n = setTimeout(function() {
        ...
        b.resolve(t || {}), h.removeEventListener("message", i), u.body.removeChild(y)
      }, i = function(t) {
        var i;
      ...
      }, h.addEventListener("message", i), y = o({
        src: e
      }, {
        display: "none"
    ...
    t.exports = {
      tweetButtonHtmlPath: "/widgets/tweet_button.eaf4b750247dd4d0c4a27df474e7e934.{{lang}}.html",
      followButtonHtmlPath: "/widgets/follow_button.eaf4b750247dd4d0c4a27df474e7e934.{{lang}}.html",
      hubHtmlPath: "/widgets/hub.html",
      widgetIframeHtmlPath: "/widgets/widget_iframe.eaf4b750247dd4d0c4a27df474e7e934.html",
    ...
    t.exports = [n(82), n(114), n(129), n(162), n(173), n(179), n(223), n(242), n(247)]
  }, function(t, e, n) {
    function r(t) {
    ...
    function i(t, e, n) {
      var i, o;
      return n = r(n), i = s.isRtlLang(e) ? "rtl" : "ltr", o = [t, u.css, n, i, "css"].join("."), d.resourceBaseUrl + "/css/" + o
    }
    function o() {
    ...
    t.exports = {
      css: "89dcaffb28dd340172342294a3b80c75"
    }
  }, , function(t, e, n) {
    function r(t) {
    ...
    function r(t, e) {
      t.getAttribute("data-image") ? a(t, e) : u(t, e)
    }
    function i(t) {
      var e = t.split(" ");
    ...
    function o(t, e, n) {
      var r, o, a, u, c;
      if (o = s(t), a = e.split(",").map(function(t) {
          return new i(t.trim())
        }), n)
        for (c = 0; c < a.length; c++) a[c].url === n && (r = a[c]);
      return u = a.reduce(function(t, e) {
        return e.width < t.width && e.width >= o ? e : t
      }, a[0]), r && r.width > u.width ? r : u
    }
    function a(t, e) {
      var n, r, i, o, a;
      n = y.decodeURL(t.src).name, r = n && b(S, function(t) {
        if (I[t] === n) return t
      }), o = s(e), r >= o || (i = t.getAttribute("data-image"), a = b(S, function(t) {
        if (t >= o) return t
      }) || 4096, t.src = y.url(i, {
        format: "jpg",
        name: I[a]
    ...
    function m(t) {
      w.inlineStyle() || (p(t, ".MediaCard-widthConstraint", "maxWidth", T), p(t, ".MediaCard-mediaContainer", "paddingBottom", R), p(t, ".CroppedImage-image", "top", A), p(t, ".CroppedImage-image", "left", C))
    }
    var v = n(7),
      g = n(11),
      w = n(65),
      ...
      S = Object.keys(I).sort(function(t, e) {
        return t - e
      });
    t.exports = {
      scaleDimensions: h,
    ...
    function r(t) {
      t.selectors({
        ...
        n.action = "seen", this.scribe(n, e, a.version)
      }), t.after("show", function() {
    ...
    var r = n(170),
      ...
      u = 50,
      c = function(t) {
        return (a.requestIdleCallback || a.requestAnimationFrame || function(t) {
          t()
        })(t)
      },
      d = function() {
    ...
    d.prototype._register = function(t, e, n) {
      var i, u = this;
      return s.hasIntersectionObserverSupport() ? (i = new a.IntersectionObserver(function(t) {
        t.forEach(function(t) {
      ...
      var e;
      s.hasIntersectionObserverSupport() && t instanceof a.IntersectionObserver ? t.disconnect() : (e = this.observers.indexOf(t), e > -1 && (this.observers.splice(e, 1), 0 === this.observers.length && this.unlisten && this.unlisten()))
    ...
    function r(t, e) {
      var n, r, a, s;
      return e = e || {}, r = e.viewportWidth || o.innerWidth, n = e.viewportHeight || o.innerHeight, a = t.getBoundingClientRect(), t.ownerDocument !== i && e.sandboxEl && (s = e.sandboxEl.getBoundingClientRect(), a = {
        top: a.top + s.top,
        bottom: a.bottom + s.top,
        left: a.left + s.left,
        right: a.right + s.left
      }), a.top >= 0 && a.left >= 0 && a.bottom <= n && a.right <= r
    }
    var i = n(9),
      o = n(7);
    t.exports = r
    ...
    function o(t) {
      t.params({
        ...
        }, o = m.aug(this.queryParams(), n), s.fetch(this.pollEndpoint, o, u, this.cbId(e)).then(r, i)
      })
    }
    var a = n(138),
      s = n(135),
    ...
    function i() {
      o && o.length === s && (a.emitter.trigger(a.ALL_WIDGETS_AND_IMAGES_LOADED, o), o = null)
    }
    var o, a = n(240),
      s = 0;
    a.emitter.bind(a.ALL_WIDGETS_RENDERED, function(t) {
      o = t.widgets, i()
    }), t.exports = {
    ...
    function r(t) {
      ...
      return s.isObject(t) || u.isString(t) ? (t = t || {}, n.forEach(function(t) {
    ...
    a.isTwitterURL(o.href) && (m.createTimelinePreview = function(t, e, n) {
      var r = {
        previewParams: t,
        useLegacyDefaults: !0,
        isPreviewTimeline: !0
    ...
    function a(t) {
      return t.reduce(function(t, e) {
        return f.aug(t, o(e.contentDocument.defaultView))
      }, {})
    }
    var s = n(240),
      u = n(278),
    ...
    s.emitter.bind(s.ALL_WIDGETS_AND_IMAGES_LOADED, function(t) {
      var e, n, s = [];
      l.hasPerformanceInformation() && (e = o(d), h.isSupported() || (s = a(t)), n = f.aug({}, e, s), i(n), r(n))
    })
  }])))
}();
